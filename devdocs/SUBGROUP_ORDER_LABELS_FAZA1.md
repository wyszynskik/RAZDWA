...
2. Po zdalnej synchronizacji z Google Apps Script (asynchroniczny blok fire-and-forget, uruchamiany _po_ `router.start()`) — tylko gdy lokalnie nie było jeszcze żadnych wariantów i właśnie przyszły z GAS.
